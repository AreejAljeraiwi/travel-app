...
const darkAPIkey = "b717b1ce4cd64befb4cfe19662283582";
...
export const getWeather = async (cityLat, cityLong, country, timestamp) => {
  ...
  const req = await fetch(`https://api.weatherbit.io/v2.0/forecast/daily?lat=${cityLat}&lon=${cityLong}&key=${darkAPIkey}`);
  try {
